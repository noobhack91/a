<!DOCTYPE html>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <meta name="google-site-verification" content="rwIeKFgRyWJBx7VpWmMFvctV7mcSL2Wi-_b_5_adVoI" />
...
></script>
<script>
        // JavaScript code to clear local storage on page reload
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-6 text-center">
                            ...
                            <nav class="mainmenu_wrapper text-right">
                                <ul class="mainmenu nav sf-menu col-md-1">
...
<div class="dropdown-content">
    ...
    <div class="inner-megamenu-ct">
      ...
      <div class="custom-mega-menu">
            <span class="close-btn" style="position: absolute; top: 10px; right: 10px; font-size: 35px; cursor: pointer;" onclick="closeDropdown(this)">&times;</span>
        <ul>
...
<div>
    <button style="display: none;" id="autoOpenButton" type="button" class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#myModal"></button>

    <!-- Modal -->
    <div style="opacity: 1;" class="modal fade" id="myModal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <div class="md-window">
                        ...
                        <p>By clicking "I AGREE AND ENTER" below, you confirm you are 18 years of age or older and you have read and accepted our <a href="{{url('term-and-conditions')}}">Terms and Condition</a></p>
   ...
   <div class="md-window-button text-center">
    <div class="button"><a href="https://www.google.com/" class="btn btn-light btn-custom-small">DECLINE</a></div>
    <form method="post" action="{{url('/enter')}}">
        @csrf
        <div class="enter-bt"><button type="submit" class="btn btn-custom-large">AGREE AND ENTER</button></div>
    </form>
</div>
<style>
    /* Add custom CSS to make buttons larger and change color */
    .btn-custom-large {
        padding: 12px 24px;
        font-size: 15px;
        background-color: #D10779 !important;
        border-color: #D10779 !important;
    ...
    color: #fff !important;
	 ...
	 @media (max-width: 768px) {
        .close-btn {
            display: block !important; /* Show the close button in mobile view */
        }
    }
...
<script>
    ...
    function openModal() {
        const canvasDiv = document.getElementById('canvas');
                canvasDiv.style.filter = 'blur(7px)'; // Apply blur when modal is closed
    ...
    function closeModal() {
        const canvasDiv = document.getElementById('canvas');
                canvasDiv.style.filter = 'none'; // Remove blur when modal is opened

    }

    // Check if the modal should be opened
    const shouldOpenModal = !localStorage.getItem('modalOpened');

    // If it should be opened, set the flag and trigger the modal
    if (shouldOpenModal) {
        localStorage.setItem('modalOpened', 'true');
        const autoOpenButton = document.getElementById('autoOpenButton');
        autoOpenButton.addEventListener('click', openModal);
        autoOpenButton.click();
    } else {
        closeModal(); // Apply initial blur if modal is already opened
    }
</script>
...
<!-- Add the script at the bottom of your HTML body -->

<script>
    function closeDropdown(button) {
        var dropdownContent = button.closest(".dropdown-content");
        dropdownContent.style.display = "none";
    }

    function toggleDropdown(dropdown) {
        var dropdownContent = dropdown.querySelector(".dropdown-content");
        var closeBtn = dropdownContent.querySelector(".close-btn");
